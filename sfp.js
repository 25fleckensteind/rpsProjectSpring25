...
/* Steps:
 ...
 7.  When it's all said and done, I will help you get GitHub to host this webpage, so that you can play it from anywhere.
 ...
 when we're completely done with this project, it will be a first player to 5 wins version of the game.  
    Make variables to keep track of the score.

 Once you've written the functions to get choices, write code to play just one round, and make sure that's working properly, 
    before you expand to the first 5 version.  

 MAKE SURE:  when the winner is declared, it should give a message like "You win!  Paper beats rock!"  
    Or "You lose!  Scissors beats paper!"  Messages like "Sorry, you lose" or "Congrats you win", 
    don't make your player trust that the program is fair. */